...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam,
  ...
  case WM_CREATE:
    ...
    hEdit = CreateWindow("EDIT", "",
                         ...
                         20, 200, 25, hwnd, (HMENU)ID_EDIT, NULL, NULL);

    // Create a button
    hButton = CreateWindow("BUTTON", "Click Me", WS_CHILD | WS_VISIBLE, 20, 60,
                           100, 30, hwnd, (HMENU)ID_BUTTON, NULL, NULL);
    break;
